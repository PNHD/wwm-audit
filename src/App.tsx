...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0e0d0b] text-[#ede5ce] font-sans antialiased selection:bg-amber-600/30 selection:text-amber-200">
      ...
      <header className="bg-[#14120f] border-b border-amber-900/30 px-4 h-11 flex items-center justify-between sticky top-0 z-30 shadow-md gap-2">
        ...
        <div className="flex items-center gap-1 overflow-x-auto scrollbar-none">
          <select
            ...
            className="bg-slate-950 border border-slate-700 text-amber-500 rounded px-2 py-0.5 text-xs focus:outline-none focus:ring-1 focus:ring-amber-500/50"
          >
          ...
          <button
            ...
            className="px-2 py-0.5 bg-slate-950 hover:bg-slate-900 border border-slate-700 text-slate-300 rounded text-[11px] flex items-center gap-1 transition-colors shrink-0"
          ><Download className="w-3 h-3 text-amber-500" /> Export</button>
          <label className="px-2 py-0.5 bg-slate-950 hover:bg-slate-900 border border-slate-700 text-slate-300 rounded text-[11px] flex items-center gap-1 cursor-pointer transition-colors shrink-0">
      ...
      {/* ── SCHEME + SUBNAV BAR ── */}
      <div className="bg-[#0a0908] border-b border-amber-500/25 px-4 h-10 flex items-center justify-between sticky top-11 z-20 gap-3 shadow-sm">
            ...
            <div
              ...
              className={`flex items-center gap-1 px-2 py-0.5 rounded cursor-pointer transition-all border text-[11px] shrink-0 ${
                charsData.activeSchemeId === s.id
                  ...
                  : "bg-slate-950/60 text-slate-500 hover:text-slate-200 border-slate-800"
              }`}
        ...
        {activeTab === "calculator" && (
          <div className="flex gap-4 items-start">
            ...
            <aside className="hidden xl:flex xl:flex-col gap-2 w-60 shrink-0 sticky top-2 max-h-[calc(100vh-1rem)] overflow-y-auto pr-1">
              <div className="bg-[#141210] border border-amber-500/20 rounded-xl p-3">
                <span className="text-[12px] font-mono font-bold tracking-widest text-amber-500 uppercase flex items-center gap-1.5 border-b border-amber-900/30 pb-1.5 mb-2">
                  ...
                  {getActiveGear().map(item => {
                    ...
                    return (
                      <div
                        ...
                        className="flex items-center gap-2 bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 rounded-lg p-1.5 cursor-pointer transition-colors"
                        title={item.name}
                      >
                        {(() => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-12 flex items-center gap-3 mb-3 p-2 bg-slate-950/60 rounded-lg border border-slate-800">
            ...
            <div className="lg:col-span-12 bg-[#141210] border border-amber-500/20 rounded-xl p-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-2">
                {SLOTS.map(slot => {
                  ...
                  if (!item) {
                    return (
                      <div key={slot.name} className="bg-slate-950/60 border border-slate-800 rounded-lg p-2 text-center opacity-50">
                        <SlotIcon />
                        <div className="text-[11px] text-slate-500 mt-1">{slot.name}</div>
                        <div className="text-[11px] text-slate-300 mt-1">— empty —</div>
                      </div>
                    );
                  }
                  ...
                  return (
                    <div
                      ...
                      className="bg-slate-950/70 border border-slate-800 hover:border-amber-500/40 rounded-lg p-2 cursor-pointer transition-colors"
                      title={item.name}
                    >
            ...
            <div className="lg:col-span-4 bg-[#141210] border border-amber-500/20 rounded-xl p-5 space-y-6">
              {/* Build Path Dropdown */}
              <div className="bg-[#1c1a17] border border-amber-900/20 rounded-xl p-4 space-y-3 shadow-md">
                <span className="text-[12px] font-mono font-bold tracking-widest text-amber-500 uppercase flex items-center gap-1.5 border-b border-amber-900/30 pb-1.5">
                ...
                <div>
                  <select
                    ...
                    className="w-full bg-slate-950 border border-slate-700 text-amber-400 rounded px-2.5 py-2 text-sm font-semibold focus:outline-none focus:ring-1 focus:ring-amber-500/50"
                  >
                ...
                {(() => {
                  ...
                  if (!b) return null;
                  return (
                    <div className="bg-slate-950/70 rounded p-2.5 border border-slate-800 text-[13px] space-y-1.5 text-slate-300 antialiased">
                      <div className="flex justify-between text-slate-500">
                        <span>Weapons:</span>
                        <span className="text-amber-500 font-medium text-right text-[12px]">{b.weapons}</span>
                      </div>
                      <div className="font-mono text-[12px] text-slate-500 border-t border-slate-800/60 pt-1.5">
                      ...
                      <div className="text-slate-500 border-t border-slate-800/60 pt-1.5 leading-relaxed text-[12.5px]">
              ...
              {/* Armor Set Selector */}
              <div className="bg-[#1c1a17] border border-amber-900/20 rounded-xl p-4 space-y-3 shadow-md">
                <span className="text-[12px] font-mono font-bold tracking-widest text-[#a19683] uppercase flex items-center gap-1.5 border-b border-amber-900/30 pb-1.5">
                ...
                <div>
                  <select
                    ...
                    className="w-full bg-slate-950 border border-slate-700 text-amber-100 rounded px-2.5 py-2 text-sm font-semibold focus:outline-none focus:ring-1 focus:ring-amber-500/50"
                  >
                ...
                {(() => {
                  ...
                  return (
                    <div className="bg-slate-950/70 rounded p-2.5 border border-slate-800 text-[13px] space-y-2 text-slate-300">
                      ...
                      {panel.set !== "none" && (
                        <div className="font-sans text-[13px] space-y-1.5 text-slate-500 border-t border-slate-800/60 pt-1.5 leading-normal">
                          <div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between gap-3 bg-slate-950/70 p-2 rounded-lg border border-slate-800/60">
                    ...
                    <div className="grid grid-cols-2 gap-2 bg-[#201d18]/40 p-2.5 rounded border border-amber-900/20">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-slate-950 text-slate-200 border border-slate-700 text-sm text-right px-2 py-1 rounded"
                        />
                      </div>
                      <div>
                  ...
                  <div className="bg-slate-950/60 p-3 rounded-lg border border-slate-800/40 text-[12px] text-slate-500 font-mono space-y-1.5 leading-relaxed">
              ...
              <div>
                ...
                <div className="space-y-2.5">
                  <div className="flex justify-between items-center bg-slate-950/70 p-2 rounded-lg border border-slate-800/60 text-sm">
              ...
              <div>
                ...
                <div className="space-y-2.5">
                  <div className="bg-slate-950/70 p-2 rounded-lg border border-slate-800/60">
                    ...
                    <div className="text-[11.5px] text-slate-500 mt-1 leading-normal font-sans border-t border-slate-800/40 pt-1">
              ...
              <div>
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="bg-[#141210] p-3 rounded-lg border border-slate-800/50 mt-4">
              ...
              <div className="pt-4 border-t border-slate-700/80">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-[12px] font-mono px-1.5 py-0.5 rounded bg-slate-950 border border-slate-800 text-amber-400 font-bold">
                ...
                <input
                  ...
                  className="w-full mb-2 px-2.5 py-1.5 bg-slate-950/70 border border-slate-700 rounded text-sm text-slate-300 placeholder-slate-600 focus:outline-none focus:border-amber-600"
                />
                <div className="flex bg-slate-950 p-0.5 rounded border border-slate-800 mb-3 text-[12px]">
                  <button
                    type="button"
                  ...
                  {INNER_WAYS.filter((iw) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {iw.note && isSelected && (
                          <div className="text-[11px] text-[#c9943a] leading-tight font-mono border-t border-amber-500/20 pt-1 mt-1 mb-1">
                            {iw.note}
                          </div>
                        )}
                        {isSelected && (
                                ...
                                return (
                                  <button
                                    ...
                                    className={`px-1 rounded font-mono text-[11px] font-bold ${
                                      isCurrent
                                        ? "bg-amber-500 text-slate-950"
                                        : "bg-slate-900/90 text-slate-500 hover:text-slate-200"
                                    }`}
                                  >
                                    T{t}
                                  </button>
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="bg-[#141210] border border-amber-500/20 rounded-xl p-5 shadow-lg relative overflow-hidden">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-3 mb-5">
                  <div className="bg-slate-950/60 border border-slate-800 p-3.5 rounded-lg text-center relative">
                  ...
                  <div className="bg-[#1b1511]/40 border border-amber-900/30 p-3.5 rounded-lg text-center relative">
                  ...
                  <div className="bg-slate-950/60 border border-slate-800 p-3.5 rounded-lg text-center relative flex flex-col justify-center">
                ...
                <div className="space-y-2 bg-[#0e0d0b] p-4 rounded-xl border border-amber-900/5">
                  ...
                  <div className="h-2.5 bg-slate-900 rounded-full border border-slate-700 overflow-hidden">
                    <div
                ...
                <div className="mt-4 p-4 rounded-lg text-sm leading-relaxed border bg-slate-950/50 border-slate-800 text-slate-300">
                  {(() => {
                    const b = BUILD_PROFILES[selectedBuild as keyof typeof BUILD_PROFILES];
                    if (!b) return null;
                    ...
                    return (
                      <>
                        ...
                        <div className="mt-2.5 pt-2 border-t border-slate-800 text-[12.5px] text-slate-500 font-mono">
              ...
              <div className="bg-[#141210] border border-amber-500/20 rounded-xl p-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3.5 text-sm">
                  <div className="bg-slate-950/60 p-3 rounded-lg border border-slate-800 flex flex-col justify-between">
                    ...
                    <div className="text-[11px] text-slate-500 mt-2 leading-snug border-t border-slate-800/40 pt-1.5 font-sans">
              ...
              <div className="bg-[#141210] border border-amber-500/20 rounded-xl p-5">
                <div className="flex justify-between items-center border-b border-amber-500/20 pb-3 mb-4">
                  ...
                  <div className="flex gap-1.5 bg-slate-950 p-1 rounded border border-slate-800 text-[12px]">
                    <button
        ...
        {activeTab === "gear" && (
          <div className="space-y-6">
            <div className="bg-[#141210] border border-amber-500/20 rounded-xl p-6">
                        ...
                        <button
                          ...
                          className={`shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-mono font-bold border transition-all ${
                            isSelected
                              ...
                              : "bg-slate-950/60 text-slate-500 hover:text-slate-200 border-slate-800/60"
                          }`}
                        >
                          <span>{tab.icon}</span>
                          <span>{tab.label}</span>
                ...
                <div className="hidden md:flex flex-col items-end gap-2.5 shrink-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      className="bg-slate-950 border border-slate-800 rounded px-2.5 py-1 text-[12px] font-mono text-slate-300 focus:outline-none focus:ring-1 focus:ring-amber-500/50"
                    >
              ...
              <div className="md:hidden flex items-center justify-between mb-4 bg-slate-950/25 p-2 rounded-lg border border-slate-800">
                <span className="text-[12px] text-slate-500 uppercase font-mono">Sort Items:</span>
                <select
                  value={gearSortBy}
                  onChange={(e) => setGearSortBy(e.target.value as "name" | "mastery")}
                  className="bg-slate-950 border border-slate-800 rounded px-2 py-1 text-[12px] font-mono text-[#ede5ce] focus:outline-none"
                >
                  <option value="name">Alphabetical</option>
                  <option value="mastery">Mastery (⚔ High to Low)</option>
                </select>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
                ...
                <div className="lg:col-span-7">
                  {(() => {
                    ...
                    if (allGear.length === 0) {
                      return (
                        <div className="bg-slate-950/40 border border-dashed border-slate-800/60 p-12 rounded-xl text-center">
                          <p className="text-slate-500 text-sm">No gear in this slot. Add your first item →</p>
                          <button
                            onClick={openAddModal}
                            className="mt-4 px-4 py-2 bg-slate-900 hover:bg-slate-850 hover:border-slate-700 text-amber-500 border border-slate-700 rounded font-bold text-sm transition-all"
                          >
                            Create first item
                          </button>
                        </div>
                    ...
                    const renderGearCard = (item: GearItem) => {
                      ...
                      const slotIcon = slotObj?.icon || <Shield className="w-4 h-4" />;
                          ...
                          <div className="space-y-3">
                            <div className="flex items-start justify-between gap-4">
                              <div className="flex items-center gap-2 min-w-0">
                                <span className="text-lg bg-slate-950/70 w-8 h-8 rounded-lg flex items-center justify-center border border-slate-800 shrink-0">
                                  {slotIcon}
                                </span>
                            ...
                            <div className="text-[12px] text-slate-300 bg-slate-950/70 p-2.5 rounded border border-slate-800 font-mono space-y-1">
                              <div className="flex items-center justify-between">
                              ...
                              {item.set && item.set !== "none" && (
                                <div className="flex items-center justify-between border-t border-slate-800/50 pt-1 mt-1">
                            ...
                            <div className="space-y-1.5 border-t border-slate-800/40 pt-2.5">
                      ...
                      <div className="space-y-6">
                        {slotsWithItems.map(({ slot, items }) => (
                          <div key={slot.name} className="space-y-3">
                            <h3 className="text-sm uppercase tracking-wider font-extrabold text-amber-500/80 font-mono border-b border-amber-900/30 pb-1.5 flex items-center gap-2">
                ...
                <div className="lg:col-span-3 lg:sticky lg:top-4 h-fit space-y-4">
                  <div className="bg-[#141210] border border-amber-900/20 rounded-xl p-4 space-y-4">
                    <div className="border-b border-amber-955/40 pb-3">
                      ...
                      <p className="text-[12px] text-slate-500 font-mono bg-slate-950/80 px-2 py-0.5 rounded border border-slate-800 inline-block">
              ...
              <div className="bg-[#141210] border border-amber-500/20 rounded-xl p-6 mt-6 shadow-lg">
        ...
        {isItemModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-sm">
            <div className="bg-[#141210] border border-amber-900/20 max-w-lg w-full rounded-2xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
              {/* Header */}
              <div className="p-4 bg-slate-950/70 border-b border-amber-500/20 flex justify-between items-center shrink-0">
                ...
                <button
                  ...
                  className="text-slate-500 hover:text-slate-200 text-base font-mono"
                >
                  ✕
                </button>
              </div>
              ...
              <div className="p-5 space-y-4 overflow-y-auto min-h-0 text-slate-300 text-sm text-left">
                <div>
                  ...
                  <input
                    ...
                    value={selectedSlot}
                    disabled
                    className="w-full bg-slate-950 border border-slate-800 rounded px-2.5 py-1.5 font-mono text-slate-500 cursor-not-allowed text-sm"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded px-2.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-amber-500"
                    />
                  </div>
                  <div>
                    <label className="block text-[12px] uppercase font-mono tracking-wider text-slate-500 mb-1">
                    ...
                    <select
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded px-2.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-amber-500 text-slate-650"
                    >
                      ...
                      <div key={sidx} className="grid grid-cols-12 gap-2 items-center">
                        <div className="col-span-6">
                          <select
                            ...
                            className="w-full bg-slate-950 border border-slate-800 rounded p-1.5 text-[13px] text-slate-350 focus:outline-none focus:ring-1 focus:ring-amber-500"
                          >
                        ...
                        <div className="col-span-4">
                          <input
                            ...
                            className="w-full bg-slate-950 border border-slate-800 rounded p-1.5 text-[13px] font-mono placeholder:text-stone-400"
                          />
                        </div>
              ...
              {/* Action Buttons */}
              <div className="p-4 bg-slate-950/70 border-t border-amber-500/20 flex justify-between items-center shrink-0 gap-2">
                <div>
                  {editingItem && (
                    <button
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => setIsItemModalOpen(false)}
                    className="px-3 py-1.5 bg-slate-900 hover:bg-slate-850 text-slate-300 rounded text-sm border border-slate-700 transition-all font-semibold"
                  >
                    Cancel
                  </button>
                  <button
            ...
            <div className="bg-[#141210] border border-amber-900/20 max-w-md w-full rounded-2xl overflow-hidden shadow-2xl flex flex-col">
              ...
              <div className="p-4 bg-slate-950/70 border-b border-amber-500/20 flex justify-between items-center shrink-0">
                ...
                <button
                  ...
                  className="text-slate-500 hover:text-slate-200 text-base font-mono cursor-pointer"
                >
                  ✕
                </button>
              </div>
              ...
              {/* Footer */}
              <div className="p-4 bg-slate-950/60 border-t border-amber-500/20 flex justify-end gap-3 shrink-0">
                <button
                  onClick={() => setShowAddCooldownModal(false)}
